...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2024 a las 21:32:43
...
--
-- Creación: 24-05-2024 a las 18:43:36
--
...
--
-- Creación: 24-05-2024 a las 18:59:13
--
...
--
-- Creación: 24-05-2024 a las 18:41:36
--
...
ALTER TABLE `producto`
  ...
  ADD KEY `id_TipoProducto` (`id_Categoria_Producto`);
...
--
ALTER TABLE `horario`
  ADD CONSTRAINT `horario_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`Id_cliente`);
